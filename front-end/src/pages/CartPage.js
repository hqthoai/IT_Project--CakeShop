...
const stripePromise = loadStripe('pk_test_51M7VRpKaVhqP4Bw3tL7U5os1F2HAbaJ5ynxg89n22cqUWuVS9YJY7jLnAHNGr9E8KhBcT1MMAcksqWgfWfqzVkIQ00akXzjl2m');
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <span className="quantity-indicator">
                                                    ...
                                                    onClick={() => handleDecrease({ productId: item._id, price: item.price, userId: user._id })}></i>
                                                    <span>{user.cart[item._id]}</span>
                                                    <i className="fa fa-plus-circle" 
                                                    onClick={() => increaseCart({ productId: item._id, price: item.price, userId: user._id })}></i>
                                                </span>
                                            </td>
